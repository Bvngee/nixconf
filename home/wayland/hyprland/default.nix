{ config, lib, inputs, pkgs, hostname, flakeRoot, ... }:
let
...
in
{
  # Some Hyprland configuration generated with nix. The rest is in ./hyprland.conf (for hot-reload purposes)
  ...
  xdg.configFile."hypr/hyprland.conf".source =
    config.lib.file.mkOutOfStoreSymlink "${flakeRoot}/home/wayland/hyprland/hyprland.conf";
  ...
  #     bind = CONTROL, Print, exec, screenshotFull
